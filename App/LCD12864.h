...
#define BSP_GPIOG_SW1         GPIO_Pin_13                       //sw1=PG12 
#define BSP_GPIOG_SW2         GPIO_Pin_12                       //sw1=PG13
...
void hz_disp16n(unsigned char pag,unsigned char col, unsigned char *hzk);
#endif
