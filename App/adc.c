...
/*******************************************************************************
* Function Name  : void delay(u32 t)
* Description    : 延时程序
* Input          : None
* Output         : None
* Return         : delay(u32 t)								   
...
* Description    : 定时器TIM5初始化,用于ADC_DMA定时触发
* Input          : None
* Output         : None
* Return         : TIM5_Configuration								   
*******************************************************************************/
...
* Description    : DMA1_CH1,TIM5中断设置
* Input          : None
* Output         : None
* Return         : NVIC_Configuration();										   
*******************************************************************************/
